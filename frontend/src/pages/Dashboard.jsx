...
export default function Dashboard() {
  const [stats, setStats] = useState({ documents: 0, mcpServers: 3 });
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div className="card">
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '16px' }}>
          This Documentation Assistant is powered by the Model Context Protocol (MCP), enabling the LangChain QA Agent to dynamically call tools across local filesystems, PDF extractors, and Qdrant vector databases.
        </p>
      </div>
    </div>
  );
